// Sample product data for different categories with images
...
function displayProducts(category) {
    ...
    const categoryData = categoriesData.categories.find(cat => cat.category_name === category);
    if (categoryData) {
        categoryData.category_products.forEach(product => {
            const productCard = `
            <div class="product-card">
            <div>
            <a class="badge_text">${product.badge_text}<a>
...
// Display products for the initial active category
